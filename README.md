...
- [Production-grade Shiny Apps with golem - Colin Fay & Vincent Guyader](https://resources.rstudio.com/rstudio-conf-2020/production-grade-shiny-apps-with-golem-colin-fay)
- [Deploying End-To-End Data Science with Shiny, Plumber, and Pins - Alex Gold](https://resources.rstudio.com/rstudio-conf-2020/deploying-end-to-end-data-science-with-shiny-plumber-and-pins-alex-gold)
-[Shiny New Things Using R Bridge the Gap in Electronic Medical Record Reporting - Brendan Graham](https://resources.rstudio.com/rstudio-conf-2020/shiny-new-things-using-r-bridge-the-gap-in-electronic-medical-record-reporting-brendan-graham)
