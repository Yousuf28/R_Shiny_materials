...
// jsondata2 is the message name 
Shiny.addCustomMessageHandler("jsondata2",
function(message){
// div_boad2 is the id name
var id = '#div_board2';
var fData =  message;
d3.select("#div_board2").selectAll("svg").remove();
d3.select("#div_board2").selectAll("table").remove();
d3.select("#div_board2").selectAll(".d3-tip").remove();
var barColor = "Tomato";
